...
export function AIMenu() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal={false}>
      ...
      >
        <Command
          className='w-full rounded-lg border border-neutral-200 shadow-md dark:border-neutral-800'
          value={value}
        ...
        >
          ...
          {isLoading ? (
            <div className='flex grow select-none items-center gap-2 p-2 text-sm text-neutral-500 dark:text-neutral-400'>
            ...
            <InputCommand
              variant='ghost'
              className='rounded-none border-b border-solid border-neutral-200 [&_svg]:hidden dark:border-neutral-800'
              value={input}
              onKeyDown={(e) => {
