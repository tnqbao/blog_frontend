...
const editorVariants = cva(
  cn(
    ...
    'rounded-md ring-offset-white placeholder:text-neutral-500/80 focus-visible:outline-none dark:ring-offset-neutral-950 dark:placeholder:text-neutral-400/80',
    '[&_[data-slate-placeholder]]:text-neutral-500/80 [&_[data-slate-placeholder]]:!opacity-100 dark:[&_[data-slate-placeholder]]:text-neutral-400/80',
